...
<DialogTitle className='text-2xl text-center font-bold'>customize your server
</DialogTitle>
...
render={({field})=>(
<FormItem>
    <FormLabel className='uppercase text-x5 font-bold text-zinc-500 dark:text-secondary/70'>
        server name
    </FormLabel>
    <FormControl>
